...
<div class="title mb-4">View list user</div>
        ...
        <tbody>
            <s:iterator value="listUser">
                <tr>
                    ...
                    <s:if test="%{delete}">
                        <a href="activeUser?id=<s:property value="%{username}"/>" class="btn btn-sm btn-outline-primary" role="button">
                            Active
                        </a>
                    </s:if>
                    <s:else>
                        <button class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#exampleModal"
                                    onclick='deleteUser("<s:property value="%{username}"/>", "<s:property value="%{fullname}"/>")'>
                            Ban
                        </button>
                    </s:else>
